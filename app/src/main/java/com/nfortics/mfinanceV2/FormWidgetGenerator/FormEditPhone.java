 ...
 */
public class FormEditPhone extends FormWidget {
    ...
    Context context;
    private String hint;
    public FormEditPhone(Context context, String name, String tag) {
        ...
        inputLayoutName = (TextInputLayout)inflator.inflate(R.layout.floating_label_phone, null);
