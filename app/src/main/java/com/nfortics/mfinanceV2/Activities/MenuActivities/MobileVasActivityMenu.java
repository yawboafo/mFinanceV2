...
public class MobileVasActivityMenu extends BaseActivity {
    ...
    private View generateActivityView(){
        ...
        View activityView = layoutInflater.inflate(R.layout.activity_mobile_vas, null, false);
    ...
    private ListView createlistMenu(View view){
        ...
        listMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        intent = new Intent(MobileVasActivityMenu.this, FieldCollectionActivity.class);
