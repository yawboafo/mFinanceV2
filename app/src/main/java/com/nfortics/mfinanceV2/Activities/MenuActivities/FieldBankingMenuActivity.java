...
public class FieldBankingMenuActivity  extends BaseActivity {
    ...
    private View generateActivityView(){
        ...
        View activityView = layoutInflater.inflate(R.layout.activity_field_banking_menu, null, false);
        ...
        listMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        Intent intents = null;
                        intents = new Intent(FieldBankingMenuActivity.this, BalancenquiryActivity.class);
    ...
    public static List<NavigationItems> getData() {
        ...
        Integer[] menuIcons = {
                R.drawable.balance,
                R.drawable.withdrawing,
                R.drawable.statement,
                R.drawable.loanapp,
                R.drawable.internaltran,
                R.drawable.moneytrans,
