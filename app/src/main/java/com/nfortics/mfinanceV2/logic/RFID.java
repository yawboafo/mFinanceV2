...
public class RFID {
	...
	public static native int InitClassName(byte[] className, byte[] MethodSend,
			byte[] MethodRecv);
	...
	public static native int InitADF(byte FileId, char Authority, int NameLen,
			byte[] ADFName);

	public static native int InitBEF(char FileId, byte FileType,
			char Authority, char FileLen);

	public static native int InitREF(char FileId, byte FileType,
			char Authority, char FileLen);

	public static native int WriteKEY();

	public static native int ReadBinary(byte FileId, byte Offset, int Count,
			byte[] RecBuf);

	public static native int UpdateBinary(byte FileId, byte Offset, int level,
			byte[] SendBuf, int Count);

	public static native int ReadRecord(byte FileId, int level, int Index,
			byte[] RecBuf, int Count);

	public static native int AppendRecord(byte FileId, int level,
			byte[] SendBuf, int Count);

	public static native int UpdateRecord(byte FileId, int level, int Index,
			byte[] SendBuf, int Count);

	public static native int SelectFile(int FileType, int SFDatalen,
			byte[] FileId);

	public static native int authentication(byte KeyID, byte[] jarray,
			byte[] Keycode, int KeyLen);
	...
	public static native int WriteKEY(byte KEY_InMode, byte KEY_Opt,
			byte KEY_ID, byte[] Key_MsgData, int Key_Msglen);
}
