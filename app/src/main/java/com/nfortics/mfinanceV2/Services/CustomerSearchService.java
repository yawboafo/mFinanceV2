 ...
 */
public class CustomerSearchService extends Service {
    Msisdn msisdn ;
    ...
    public CustomerSearchService(Handler handler) {
        super(handler);
    }
        ...
        public void run() {
            try {
                ...
                Message message = new Message();
                    ...
                    // this.request = new CustomerSearchRequest(probeCustomer);
                    final ArrayList<Merchant> users = new ArrayList<Merchant>();
                    HTTPRequest httpRequest = new HTTPRequest();
                    InputStream inputStream = httpRequest.processGetRequest(newRequest);
                ...
                bundle.putString("request_class_name",
