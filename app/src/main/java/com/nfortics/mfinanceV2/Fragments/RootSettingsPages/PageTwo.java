...
public class PageTwo extends Fragment {
    ...
    private PageTwoInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.PageTwoInteraction(uri);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (PageTwoInteractionListener) activity;
     ...
     */
    public interface PageTwoInteractionListener {
