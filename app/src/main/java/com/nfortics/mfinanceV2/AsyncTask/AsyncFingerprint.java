...
import com.nfortics.mfinanceV2.logic.FingerprintAPI.Result;
import com.nfortics.mfinanceV2.logic.FingerprintAPI;
...
public class AsyncFingerprint extends Handler {
	...
	public AsyncFingerprint(Looper looper,
		...
		fingerprint = new FingerprintAPI(communicateManager);
	}
	...
	protected class WorkerHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case PS_Enroll:
				...
				AsyncFingerprint.this.obtainMessage(PS_Enroll, valueEnroll).sendToTarget();
				break;
			case PS_Identify:
				Result valueIdentify = fingerprint.PSIdentify();
				AsyncFingerprint.this.obtainMessage(PS_Identify, valueIdentify).sendToTarget();
				break;
			default:
				break;
			}
